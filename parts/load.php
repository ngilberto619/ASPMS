...
$query2="select * from t".$_SESSION['Phone']." ";
$ex2=mysql_query($query2) or die("<div class='error'>Error! Not select 2</div>");
echo"<table align='center' id='recutT'>";
       echo"<tr>";
       echo"<th>Parts Name</th>";
       echo"<th>Quantity</th>";
       echo"<th>Price</th>";
       echo"</tr> ";
       $total1=0;
...
echo"<h3>The receipt is made on: ".date("Y-m-d H:i:s")." <br> By: ".$_SESSION['First_Name']." ".$_SESSION['Last_Name']."</h3><br>";
echo"<h3>Approval: </h3>";
