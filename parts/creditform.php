...
document.getElementById("district").innerHTML="<option value='Nyarugenge'>Nyarugenge</option><option value='Kicukiro'>Kicukiro</option value='Gasabo'><option>Gasabo</option>";	
}
}
</script>
...
<tr> <td class="field-caption" >
        <div align="left">
                <span style="font-size: 14px">
                        <Strong>Credit Expiration Date: </Strong>
                </span>
        </div>
</td> <td>
        <input name="date" type="date" id="phone"class="dc-input" value="" required='required'placeholder="date" />
...
<tr> <td class="field-caption" >
 ...
 <INPUT   maxlength="15" name="Phone" id="phone" type="text" class="dc-input" value="" required='required' placeholder="Phone Number" >
    &nbsp;<font class="star" color="Red">*</font>
</td> 
</tr>
<tr> <td class="field-caption" >
...
<tr>
 <input name="credit" type="hidden"  value="credit" required='required'placeholder="number" />
